...
int main(void)
{
    ...
    ck_assert_msg(dpl_get_index_of_element(numbers, 'a') == -1, "Incorrect implementation for list = NULL of dpl_get_index_of_element()");
    ...
    ck_assert_msg(dpl_get_element_at_index(numbers,0) == 'a', "Incorrect implementation of dpl_insert_at_index()");
    dpl_insert_at_index(numbers, '\e', -1);
    ck_assert_msg(dpl_size(numbers) == 2, "Numbers must contain 2 elements.");
    ck_assert_msg(dpl_get_element_at_index(numbers,0) == '\e', "Incorrect implementation of dpl_insert_at_index()");
    ck_assert_msg(dpl_get_element_at_index(numbers,1) == 'a', "Incorrect implementation of dpl_insert_at_index()");
    dpl_insert_at_index(numbers, 'b', 100);
    ck_assert_msg(dpl_size(numbers) == 3, "Numbers must contain 3 elements.");
    ck_assert_msg(dpl_get_element_at_index(numbers,2) == 'b', "Incorrect implementation of dpl_insert_at_index()");
    dpl_insert_at_index(numbers, 'x', 2);
    ck_assert_msg(dpl_size(numbers) == 4, "Numbers must contain 4 elements.");
    ck_assert_msg(dpl_get_element_at_index(numbers,2) == 'x', "Incorrect implementation of dpl_insert_at_index()");
    ck_assert_msg(dpl_get_element_at_index(numbers,3) == 'b', "Incorrect implementation of dpl_insert_at_index()");
    dpl_insert_at_index(numbers, 'c', 3);
    ck_assert_msg(dpl_get_element_at_index(numbers, 3) == 'c', "Incorrect implementation of dpl_get_element_at_index()");
    dpl_remove_at_index(numbers, 3);
    ck_assert_msg(dpl_get_element_at_index(numbers, 3) == 'b', "Incorrect implementation of dpl_remove_at_index()");
    dpl_remove_at_index(numbers, 2);
    ck_assert_msg(dpl_get_element_at_index(numbers, 2) != 'x', "Incorrect implementation of dpl_remove_at_index()");
    ck_assert_msg(dpl_get_element_at_index(numbers, 2) == 'b', "Incorrect implementation of dpl_remove_at_index()");
    dpl_remove_at_index(numbers, -1);
    ck_assert_msg(dpl_get_element_at_index(numbers, 0) != '\e', "Incorrect implementation of dpl_remove_at_index()");
    ck_assert_msg(dpl_get_element_at_index(numbers, 0) == 'a', "Incorrect implementation of dpl_remove_at_index()");
    dpl_insert_at_index(numbers, '\e', -1);
    dpl_insert_at_index(numbers, 'c', 3);
    ck_assert_msg(dpl_get_element_at_index(numbers, 3) == 'c', "Incorrect implementation of dpl_get_element_at_index()");
    ...
    ck_assert_msg(dpl_get_element_at_index(numbers, -1) == '\e', "Incorrect implementation of dpl_get_element_at_index()");
    ck_assert_msg(dpl_get_element_at_index(numbers, 0) == '\e', "Incorrect implementation of dpl_get_element_at_index()");
    ck_assert_msg(dpl_get_element_at_index(numbers, 1) == 'a', "Incorrect implementation of dpl_get_element_at_index()");
    ck_assert_msg(dpl_get_element_at_index(numbers, 2) == 'b', "Incorrect implementation of dpl_get_element_at_index()");
    ck_assert_msg(dpl_get_element_at_index(numbers, 20) == 'b', "Incorrect implementation of dpl_get_element_at_index()");
